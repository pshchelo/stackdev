...
def parse_args():
    ...
    (
        parser.add_argument(
            "--libvirt", type=str, default=None, help="Libvirt URI to connect to"
        ),
    )
    parser.add_argument(
        "--kernel",
        type=str,
        default=None,
        help="Kernel to boot with, required when booting as 'direct'",
    )
    parser.add_argument(
        "--initrd",
        type=str,
        default=None,
        help="Initrd to boot with, required when booting as 'direct'",
    )
