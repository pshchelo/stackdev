...
echo "ensuring user alt-demo exists"
...
# readonly user
echo "ensuring read-only user viewer exists"
openstack --os-cloud mosk-dev-admin user create --or-show viewer --domain Default --password viewer
...
# TODO: make everything below idempotent, create -> ensure
